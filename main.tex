...
\author{Luiz Antônio Lima de Freitas Leite\inst{1}, Italo Martins Costa\inst{1}, \\(aimee...)\inst{1}}
...
\begin{abstract} 
  This paper investigates the social impacts of cognitive automation, focusing on human interaction with Large Language Models (LLMs). It analyzes the dissonance between the mathematical, stochastic nature of AI and the emotional projection of users (ELIZA Effect), which creates 
\end{abstract}
     
\begin{resumo} 
  \textcolor{red}{[revisar ambos os resumos, mas tambem acho que esta bem caprichado]}
...
\textcolor{red}{[revisar, acho que falta fazer menção à proposta de solução de alguma forma]}
...
\textcolor{red}{[revisar, poderia usar titulo mais amplo pra englobar casos não fatais e então colocar casos fatais como sub-seção]}
...
citar embasamento principalmente na técnica de Constitutional AI da Anthropic \cite{bai2022constitutional} 
...
A necessidade de processos democráticos na governança da IA também foi endossada pela iniciativa \textit{Democratic Inputs to AI} da OpenAI em 2023. O programa demonstrou que metodologias de deliberação coletiva podem ser utilizadas para resolver dilemas éticos onde não existe um consenso claro, fornecendo uma base legítima para a criação de diretrizes que operam acima dos interesses puramente corporativos \cite{openai2023democratic}.

\section{Conclusão}

\textcolor{red}{[construir no final]}
